...
public class GitHelper {
	 ...
	 * @param username
	 *            username to be used for cloning the repository
	 * @param password
	 *            password matching with the provided username to be used for
	 *            authentication
	 * @param directory
	 *            the path in which the git repository should be cloned
	 * @throws GitAPIException
	 *             if anything's going wrong while cloning the repository
	 */
	public static void clone(String url, String username, String password,
		...
		try {
			...
			LOGGER.info("Repository sucessfully cloned");
	 ...
	 *
	 * @param directory
	 *            the directory in which the local git repository is located
	 * @param username
	 *            the username to be used while pushing
	 * @param password
	 *            the password matching with the provided username to be used
	 *            for authentication
	 * @param message
	 ...
	 * @throws IOException
	 *             if something's going wrong while manipulating the local
	 *             repository
	 */
	public static void commitAndPush(File directory, String username,
		...
		try {
			...
			addCommand.call();
			LOGGER.info("Added content of the directory" + directory
			...
			LOGGER.info("Commited the changes in the Git repository...");
			// and finally push
			final UsernamePasswordCredentialsProvider userCredential = new UsernamePasswordCredentialsProvider(
					username, password);
			git.push().setCredentialsProvider(userCredential).call();
			LOGGER.info("Pushed the changes in remote Git repository...");
		} catch (final GitAPIException e) {
			LOGGER.error(e.getMessage(), e);
			throw e;
		}
