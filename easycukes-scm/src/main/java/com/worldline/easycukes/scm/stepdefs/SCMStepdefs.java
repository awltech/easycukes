...
public class SCMStepdefs {
	...
	protected static final EasyCukesConfiguration<CommonConfigurationBean> configuration = new EasyCukesConfiguration<>(
	...
	public void cloneAGitRepository(String url, String target) {
		...
		final String fullPath = baseUrl.replace(SCM_BASE_URL, "")
	 ...
	 *             if anything's going wrong...
	 */
	@Given("^the gitlab repository located in \"([^\"]*)\" is cloned into \"([^\"]*)\"$")
	public void cloneAGitlabRepository(String url, String target) {
		String username = "";
		String password = null;
		if (configuration.getValues().credentials != null) {
			username = configuration.getValues().credentials.getLogin() != null ? configuration
		...
		final String fullPath = DataInjector.injectData(url);
		log.info("fullPath VK :" + fullPath);
		// then clone
		GitHelper.clone(fullPath, username, password,
				DataInjector.injectData(target));
	}
	...
	public void cloneAMercurialRepository(String url, String target) throws HgException{
		final String baseUrl = ExecutionContext.get(Constants.BASEURL);
		String username = "";
		String password = null;
		if (configuration.getValues().credentials != null) {
	...
	public void commitAndPushInAMercurialRepository(String localRepository, String remoteRepository, String message) throws Exception{
	...
	public void checkoutAnSVNRepository(String url, String target) throws SVNException{
	...
	public void commitInAnSVNRepository(String repository, String message) throws SVNException {
