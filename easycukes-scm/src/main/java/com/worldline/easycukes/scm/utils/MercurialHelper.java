...
public class MercurialHelper {
	 ...
	 * @param username
	 *            the username to use in order to clone the repository
	 * @param password
	 *            the password linked to the specified username to be used for
	 *            authentication
	 * @param directory
	 *            the directory in which the Hg repository should be cloned
	 * @throws HgException
	 *             if something's going wrong while interacting with the Hg
	 *             repository
	 * @throws CancelledException
	 *             if cloning of the repository has been canceled for some
	...
	public static void clone(String url, String username, String password,
		...
		LOGGER.info("Cloning from " + url + " to " + directory);
		...
		try {
			...
			LOGGER.info("Hg repository cloned from: " + url + " to: "
					+ directory);
	 ...
	 *
	 * @param url
	 *            the URL of the remote Hg repository
	 * @param username
	 *            the username to be used for pushing the changes
	 * @param password
	 *            the password linked to the specified username to be used for
	 *            authentication
	 * @param directory
	 *            the directory in which the local hg repository is located
	 * @param message
	 *            the message to be used for the commit
	 * @throws Exception
	 *             if something's going wrong in that process. Various kinds of
	...
	public static void commitAndPush(String url, String username,
		...
		LOGGER.info("Commiting changes in Hg repository located in "
				+ directory.toString());
		...
		if (!outcome.isOk()) {
			LOGGER.error(outcome.getMessage());
		...
		LOGGER.info("Changes commited and pushed on Hg repository...");
	}
	 ...
	 *
	 * @param addRemoveCmd
	 *            the {@link HgAddRemoveCommand} to be executed
	 * @param location
	 *            the location on which files should be added
	 * @param parentDir
	 *            the parent directory in which files should be added
	 */
	 ...
	 *            the URL of the remote Hg repository
	 * @param username
	 *            the username to be used for interacting with the repository
	 * @param password
	 *            the password corresponding to the specified username
