...
public class SeleniumCommonStepdefs extends SeleniumAbstractStepdefs {
	 ...
	 *
	 * @param path
	 *            path on which you want to navigate
	 */
	 ...
	 *
	 * @param selector
	 *            kind of selector to use in order to identify the element
	 * @param value
	 *            value of the selector allowing to identify the element
	 * @throws Exception
	 */
	 ...
	 *            value of the selector allowing to identify the element
	 * @param text
	 *            text to be selected from the element
	 * @throws Exception
	 */
	 ...
	 *
	 * @param text
	 *            text to be sent to the specified element
	 * @param selector
	 *            kind of selector to use in order to identify the element
	 * @param value
	 *            value of the selector allowing to identify the element
	 ...
	 *            value of the selector allowing to identify the element
	 * @param text
	 *            text that should be contained by the element
	 * @throws Throwable
	 */
	 ...
	 * 
	 * @param text
	 *            the text that should be contained by the notification message
	 * @throws Throwable
	 */
	 ...
	 * 
	 * @param attribute
	 *            the attribute that needs to be loaded
	 * @param selector
	 *            kind of selector to use in order to identify the element
	 * @param value
	 *            value of the selector allowing to identify the element
	 ...
	 * 
	 * @param attribute
	 *            attribute of the element to be checked
	 * @param selector
	 *            kind of selector to use in order to identify the element
	 * @param value
	 *            value of the selector to use in order to identify the element
	 * @param text
	 *            text that should be contained by the attribute
	 * @throws Throwable
	 */
	 ...
	 * 
	 * @param key
	 *            key to be used for storing under the execution context
	 * @param attribute
	 *            attribute that needs to be saved in the context
	 * @param selector
	 *            kind of selector to use in order to identify the element
	 * @param value
	 *            value of the selector allowing to identify the element
	 ...
	 * 
	 * @param text
	 *            text that should be present in the page source code
	 * @throws Throwable
	 */
	 ...
	 * 
	 * @param selector
	 *            kind of selector to use in order to identify an element
	 * @param value
	 *            value of the selector allowing to identify an element
	 * @throws Throwable
	 */
	 ...
	 *            value of the selector allowing to identify an element
	 * @param text
	 *            text that should be present in the element
	 * @throws Throwable
	 */
